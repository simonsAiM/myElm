  ...
  <div class="rating_page">
    ...
    <section v-if="!showLoading">
      <section class="category_title">
        <span :class="{ choosed: categoryType === 1 }" @click="categoryType = 1"
          >红包</span
        >
        <span :class="{ choosed: categoryType === 2 }" @click="categoryType = 2"
          >商家代金券</span
        >
      </section>
            ...
            <header class="hongbao_title">
              ...
              <section class="hongbao_description">
                <img
                  ...
                  width="24"
                />
                <router-link to="/benefit/hbDescription" class="hongbao_detail"
                  >红包说明</router-link
                >
              </section>
            </header>
...
export default {
  ...
  methods: {
    async initData() {
      if (this.userInfo) {
        let res = await getHongbaoNum(this.userInfo.user_id);
        this.hongbaoList = JSON.parse(res)
